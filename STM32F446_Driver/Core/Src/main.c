...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOA, DISPLAY_D16_Pin|DISPLAY_D17_Pin|DISPLAY_D18_Pin|DISPLAY_D19_Pin
                          |DISPLAY_D20_Pin|DISPLAY_D21_Pin|DISPLAY_D22_Pin|DISPLAY_D23_Pin
                          |DISPLAY_DC_Pin|DISPLAY_D11_Pin|DISPLAY_RD_Pin|DISPLAY_WR_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, DISPLAY_D0_Pin|DISPLAY_D1_Pin|DISPLAY_D2_Pin|DISPLAY_D10_Pin
                          ...
                          |DISPLAY_D7_Pin|DISPLAY_D8_Pin|DISPLAY_D9_Pin, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = DISPLAY_D16_Pin|DISPLAY_D17_Pin|DISPLAY_D18_Pin|DISPLAY_D19_Pin
                          |DISPLAY_D20_Pin|DISPLAY_D21_Pin|DISPLAY_D22_Pin|DISPLAY_D23_Pin
                          |DISPLAY_DC_Pin|DISPLAY_D11_Pin|DISPLAY_RD_Pin|DISPLAY_WR_Pin;
  ...
  GPIO_InitStruct.Pin = DISPLAY_D0_Pin|DISPLAY_D1_Pin|DISPLAY_D2_Pin|DISPLAY_D10_Pin
                          |DISPLAY_D12_Pin|DISPLAY_D13_Pin|DISPLAY_D14_Pin|DISPLAY_D15_Pin
                          |DISPLAY_D3_Pin|DISPLAY_D4_Pin|DISPLAY_D5_Pin|DISPLAY_D6_Pin
                          |DISPLAY_D7_Pin|DISPLAY_D8_Pin|DISPLAY_D9_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
